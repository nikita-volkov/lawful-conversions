...
instance NormalizesTo Data.ByteString.Builder.Builder Data.Text.Array.Array where
  to = Data.ByteString.Builder.shortByteString . LawfulConversions.TextCompat.Array.toShortByteString

instance NormalizesTo Data.Text.Array.Array Data.ByteString.Builder.Builder where
  to =
