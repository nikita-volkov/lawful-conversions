...
instance NormalizesTo Data.Text.Lazy.Text Data.Text.Lazy.Builder.Builder where
  to = Data.Text.Lazy.Builder.toLazyText
  maybeFrom = Just . Data.Text.Lazy.Builder.fromLazyText

instance NormalizesTo Data.Text.Lazy.Builder.Builder Data.Text.Lazy.Text where
