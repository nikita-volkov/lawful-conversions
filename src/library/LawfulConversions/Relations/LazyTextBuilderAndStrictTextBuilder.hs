...
instance IsSubsetOf Data.Text.Lazy.Builder.Builder Data.Text.Encoding.StrictTextBuilder where
  to = Data.Text.Lazy.Builder.fromText . Data.Text.Encoding.strictBuilderToText

instance IsSubsetOf Data.Text.Encoding.StrictTextBuilder Data.Text.Lazy.Builder.Builder where
