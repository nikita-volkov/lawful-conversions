...
instance NormalizesTo Data.ByteString.Short.ShortByteString Data.Text.Array.Array where
  to = LawfulConversions.TextCompat.Array.toShortByteString

instance NormalizesTo Data.Text.Array.Array Data.ByteString.Short.ShortByteString where
