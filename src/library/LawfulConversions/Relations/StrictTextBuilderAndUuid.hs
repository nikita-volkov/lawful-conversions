...
instance NormalizesTo Data.Text.Encoding.StrictTextBuilder UUID where
  ...
  onfrom = fromMaybe Data.UUID.Types.nil . Data.UUID.Types.fromText . Data.Text.Encoding.strictBuilderToText
...
instance NormalizesTo Data.Text.Encoding.StrictBuilder UUID where
  to = Data.Text.Encoding.textToStrictBuilder . Data.UUID.Types.toText
  maybeFrom = Data.UUID.Types.fromText . Data.Text.Encoding.strictBuilderToText
  onfrom = fromMaybe Data.UUID.Types.nil . Data.UUID.Types.fromText . Data.Text.Encoding.strictBuilderToText
